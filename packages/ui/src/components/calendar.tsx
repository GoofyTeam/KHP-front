    ...
    <DayPicker
      ...
      classNames={{
        ...
        [UI.DayButton]: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-khp-primary hover:text-primary-foreground"
        ),
        [SelectionState.range_end]: "day-range-end",
        [SelectionState.selected]:
          "bg-khp-primary text-primary-foreground hover:bg-khp-primary hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground",
        [SelectionState.range_middle]:
          "aria-selected:bg-khp-primary/10 aria-selected:text-accent-foreground",
