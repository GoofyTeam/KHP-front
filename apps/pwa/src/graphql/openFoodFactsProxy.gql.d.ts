...
export type OpenFoodFactsProxyQuery = {
  __typename?: "Query";
  search?: {
    ...
    unit?: string | null;
    is_already_in_database?: boolean | null;
    ingredient_id?: string | null;
  } | null;
};

export const OpenFoodFactsProxy = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "openFoodFactsProxy" },
      variableDefinitions: [
        {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "is_already_in_database" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "ingredient_id" },
                },
              ],
            },
          },
  ...
  OpenFoodFactsProxyQueryVariables
>;
