    ...
    data: Array<{
      ...
      order: {
        ...
        table: {
          ...
          id: string;
          label: string;
          room: { __typename?: "Room"; name: string };
        };
      };
    }>;
    paginatorInfo: {
  ...
  categories: {
    ...
    data: Array<{
      ...
      shelfLives: Array<{
        ...
        locationType: { __typename?: "LocationType"; id: string; name: string };
      }>;
    }>;
    paginatorInfo: {
      __typename?: "PaginatorInfo";
  ...
  ingredient?: {
    ...
    quantities: Array<{
      ...
      location: {
        ...
        id: string;
        name: string;
        locationType?: { __typename?: "LocationType"; name: string } | null;
      };
    }>;
...
export type GetLocationTypesQuery = {
  __typename?: "Query";
  locationTypes: {
    __typename?: "LocationTypePaginator";
    data: Array<{
...
export type GetMeasurementUnitsQuery = {
  __typename?: "Query";
...
export type GetMenuByIdQuery = {
  ...
  menu?: {
    ...
    menu_type?: { __typename?: "MenuType"; id: string; name: string } | null;
    categories: Array<{
      __typename?: "MenuCategory";
      id: string;
      name: string;
...
export type GetMostUsedIngredientsQueryVariables = Exact<{
  [key: string]: never;
}>;

export type GetMostUsedIngredientsQuery = {
  __typename?: "Query";
  ingredients: {
    __typename?: "IngredientPaginator";
    data: Array<{
      __typename?: "Ingredient";
      name: string;
      withdrawals_this_week_count: number;
    }>;
  };
};
...
export type GetOrdersQuery = {
  ...
  orders: {
    ...
    data: Array<{
      ...
      price: number;
      created_at: any;
      table: { __typename?: "Table"; label: string; id: string };
      steps: Array<{
        __typename?: "OrderStep";
        id: string;
        status: OrderStepStatusEnum;
        ...
        menus: Array<{ __typename?: "Menu"; name: string }>;
      }>;
    }>;
  };
};
...
export type GetPerishableQuery = {
  __typename?: "Query";
  soon: Array<{
    __typename?: "Perishable";
    id: string;
...
export type GetPreparationByIdQuery = {
  __typename?: "Query";
  preparation?: {
    __typename?: "Preparation";
    id: string;
...
export type GetPublicMenusSettingsQueryVariables = Exact<{
  [key: string]: never;
}>;

export type GetPublicMenusSettingsQuery = {
  __typename?: "Query";
  me: {
    __typename?: "User";
    company?: {
...
export type GetQuickAccessButtonQueryVariables = Exact<{
  [key: string]: never;
}>;

export type GetQuickAccessButtonQuery = {
  __typename?: "Query";
  quickAccesses: Array<{
    __typename?: "QuickAccess";
    id: string;
...
export type GetQuickAccessesQuery = {
  __typename?: "Query";
  quickAccesses: Array<{
    __typename?: "QuickAccess";
    id: string;
...
export type TakinOrdersQueryQuery = {
  __typename?: "Query";
  order?: {
    __typename?: "Order";
    id: string;
    ...
    table: { __typename?: "Table"; id: string; label: string };
  } | null;
  menus: {
    __typename?: "MenuPaginator";
    data: Array<{
...
export const ChefsOrderStepsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "ChefsOrderSteps" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "orderSteps" },
            arguments: [
              {
                kind: "Argument",
                ...
                value: {
                  kind: "ListValue",
                  values: [
                    { kind: "EnumValue", value: "IN_PREP" },
                    { kind: "EnumValue", value: "READY" },
                  ],
                },
              },
              {
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "stepMenus" },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [
                            {
  ...
  ChefsOrderStepsQuery,
  ChefsOrderStepsQueryVariables
>;
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "shelfLives" },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "shelf_life_hours" },
                            },
                            {
                              kind: "Field",
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetCompanyOptions" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      { kind: "Field", name: { kind: "Name", value: "name" } },
                      {
                        ...
                        name: {
                          kind: "Name",
                          value: "open_food_facts_language",
                        },
                      },
                    ],
                  },
...
>;
export const GetIngredientDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetIngredient" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "base_quantity" },
                },
                { kind: "Field", name: { kind: "Name", value: "base_unit" } },
                { kind: "Field", name: { kind: "Name", value: "allergens" } },
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "quantities" },
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
                      {
                ...
                },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "quantity_before" },
                      },
                      {
                        kind: "Field",
...
} as unknown as DocumentNode<GetIngredientQuery, GetIngredientQueryVariables>;
export const GetIngredientsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetIngredients" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "page" } },
...
} as unknown as DocumentNode<GetIngredientsQuery, GetIngredientsQueryVariables>;
export const GetLocationTypesDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetLocationTypes" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
        ...
        },
        {
          ...
          type: {
            ...
            type: {
              ...
              type: {
                kind: "NamedType",
                name: { kind: "Name", value: "OrderByClause" },
              },
            },
          },
        },
...
export const GetMeasurementUnitsDocument = {
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetMeasurementUnits" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "measurementUnits" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
  ...
  GetMeasurementUnitsQueryVariables
>;
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "public_priority" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "menu_type_id" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "menu_type" },
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
                      { kind: "Field", name: { kind: "Name", value: "id" } },
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "service_type" },
                },
                {
                  kind: "Field",
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "is_a_la_carte" },
                },
                {
                  kind: "Field",
...
export const GetMenuTypesDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetMenuTypes" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "menuTypes" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                { kind: "Field", name: { kind: "Name", value: "id" } },
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "public_index" },
                },
              ],
            },
          },
...
} as unknown as DocumentNode<GetMenuTypesQuery, GetMenuTypesQueryVariables>;
...
export const GetMostUsedIngredientsDocument = {
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetMostUsedIngredients" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
                  ...
                  fields: [
                    {
                      ...
                      value: {
                        kind: "StringValue",
                        value: "withdrawals_this_week_count",
                        block: false,
                      },
                    },
                    {
  ...
  GetMostUsedIngredientsQuery,
  GetMostUsedIngredientsQueryVariables
>;
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetPerishable" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
            kind: "Field",
            alias: { kind: "Name", value: "soon" },
            name: { kind: "Name", value: "perishables" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "filter" },
                value: { kind: "EnumValue", value: "SOON" },
              },
            ],
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "expiration_at" },
                },
              ],
            },
          },
...
} as unknown as DocumentNode<GetPerishableQuery, GetPerishableQueryVariables>;
export const GetPreparationByIdDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetPreparationById" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "preparable_quantity" },
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
                      { kind: "Field", name: { kind: "Name", value: "unit" } },
  ...
  GetPreparationByIdQueryVariables
>;
export const GetPreparationsDocument = {
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetPreparations" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "page" } },
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "preparations" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "page" },
  ...
  GetPreparationsQuery,
  GetPreparationsQueryVariables
>;
export const GetPublicMenusSettingsDocument = {
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetPublicMenusSettings" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "public_menu_settings" },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [
                            {
                              ...
                              name: {
                                kind: "Name",
                                value: "public_menu_card_url",
                              },
                            },
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "show_menu_images" },
                            },
                            {
                              kind: "Field",
                              name: {
                                kind: "Name",
                                value: "show_out_of_stock_menus_on_card",
                              },
                            },
                          ],
                        },
  ...
  GetPublicMenusSettingsQueryVariables
>;
export const GetQuickAccessButtonDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetQuickAccessButton" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "quickAccesses" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                { kind: "Field", name: { kind: "Name", value: "id" } },
                ...
                { kind: "Field", name: { kind: "Name", value: "icon_color" } },
  ...
  GetQuickAccessButtonQuery,
  GetQuickAccessButtonQueryVariables
>;
export const GetQuickAccessesDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
  ...
  GetQuickAccessesQuery,
  GetQuickAccessesQueryVariables
>;
                            ...
                            },
                            {
                              ...
                              selectionSet: {
                                ...
                                selections: [
                                  ...
                                  {
                                    kind: "Field",
                                    name: { kind: "Name", value: "pending_at" },
                                  },
                                ],
                              },
                            },
...
export const GetThresholdDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetThreshold" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
          ...
          {
            kind: "Field",
            name: { kind: "Name", value: "PreparationsThreshold" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                { kind: "Field", name: { kind: "Name", value: "id" } },
...
} as unknown as DocumentNode<GetThresholdQuery, GetThresholdQueryVariables>;
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "searchIngredients" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "searchInStock" },
            arguments: [
              {
                kind: "Argument",
...
>;
export const TakinOrdersQueryDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "TakinOrdersQuery" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                { kind: "Field", name: { kind: "Name", value: "id" } },
                { kind: "Field", name: { kind: "Name", value: "price" } },
                { kind: "Field", name: { kind: "Name", value: "served_at" } },
                { kind: "Field", name: { kind: "Name", value: "pending_at" } },
                { kind: "Field", name: { kind: "Name", value: "payed_at" } },
                { kind: "Field", name: { kind: "Name", value: "canceled_at" } },
                ...
                { kind: "Field", name: { kind: "Name", value: "created_at" } },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "served_at" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "status" },
  ...
  TakinOrdersQueryQuery,
  TakinOrdersQueryQueryVariables
>;
