...
export type GetMenuByIdQuery = { __typename?: 'Query', menu?: { __typename?: 'Menu', id: string, name: string, image_url?: string | null, price: number, description?: string | null, public_priority: number, menu_type_id: string, service_type: MenuServiceTypeEnum, is_returnable: boolean, type: string, allergens: Array<AllergenEnum>, available: boolean, is_a_la_carte: boolean, categories: Array<{ __typename?: 'MenuCategory', id: string, name: string }>, items: Array<{ __typename?: 'MenuItem', id: string, quantity: number, unit: UnitEnum, location: { __typename?: 'Location', id: string, name: string }, entity: { __typename?: 'Ingredient', id: string, name: string, unit: UnitEnum, image_url?: string | null, quantities: Array<{ __typename?: 'IngredientQuantity', quantity: number, location: { __typename?: 'Location', name: string, id: string } }> } | { __typename?: 'Preparation', id: string, name: string, unit: UnitEnum, image_url?: string | null, quantities: Array<{ __typename?: 'PreparationQuantity', quantity: number, location: { __typename?: 'Location', name: string, id: string } }> } }> } | null };
...
export type GetMenusQuery = { __typename?: 'Query', menus: { __typename?: 'MenuPaginator', data: Array<{ __typename?: 'Menu', id: string, name: string, image_url?: string | null, description?: string | null, is_a_la_carte: boolean, available: boolean, created_at: any, updated_at: any, items: Array<{ __typename?: 'MenuItem', id: string, quantity: number, unit: UnitEnum, location: { __typename?: 'Location', id: string, name: string } }> }>, paginatorInfo: { __typename?: 'PaginatorInfo', count: number, currentPage: number, hasMorePages: boolean, lastPage: number, perPage: number, total: number, firstItem?: number | null, lastItem?: number | null } } };
