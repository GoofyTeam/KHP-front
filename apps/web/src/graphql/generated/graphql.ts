...
export type GetIngredientQuery = { __typename?: 'Query', ingredient?: { __typename?: 'Ingredient', id: string, name: string, unit: UnitEnum, image_url?: string | null, quantities: Array<{ __typename?: 'IngredientQuantity', quantity: number, location: { __typename?: 'Location', id: string, name: string, locationType?: { __typename?: 'LocationType', name: string } | null } }>, category: { __typename?: 'Category', id: string, name: string }, stockMovements: Array<{ __typename?: 'StockMovement', id: string, type: string, quantity: number, quantity_before?: number | null, quantity_after?: number | null, created_at: any, location: { __typename?: 'Location', id: string, name: string }, user?: { __typename?: 'User', id: string, name: string } | null }> } | null };
