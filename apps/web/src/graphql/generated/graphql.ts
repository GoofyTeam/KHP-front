...
export type GetOrdersQuery = { __typename?: 'Query', orders: { __typename?: 'OrderPaginator', paginatorInfo: { __typename?: 'PaginatorInfo', count: number, currentPage: number, firstItem?: number | null, hasMorePages: boolean, lastItem?: number | null, lastPage: number, perPage: number, total: number }, data: Array<{ __typename?: 'Order', id: string, price: number, status: OrderStatusEnum, table: { __typename?: 'Table', id: string, label: string, room: { __typename?: 'Room', id: string, name: string } }, steps: Array<{ __typename?: 'OrderStep', stepMenus: Array<{ __typename?: 'StepMenu', menu: { __typename?: 'Menu', name: string } }> }> }> } };
