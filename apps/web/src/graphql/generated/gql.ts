 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetMenuCategories($first: Int, $page: Int) {\n  menuCategories(first: $first, page: $page) {\n    data {\n      name\n      id\n      created_at\n      updated_at\n    }\n    paginatorInfo {\n      count\n      currentPage\n      firstItem\n      hasMorePages\n      lastItem\n      lastPage\n      perPage\n      total\n    }\n  }\n}"): (typeof documents)["query GetMenuCategories($first: Int, $page: Int) {\n  menuCategories(first: $first, page: $page) {\n    data {\n      name\n      id\n      created_at\n      updated_at\n    }\n    paginatorInfo {\n      count\n      currentPage\n      firstItem\n      hasMorePages\n      lastItem\n      lastPage\n      perPage\n      total\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetQuickAccessButton {\n  quickAccesses {\n    id\n    name\n    icon\n    icon_color\n    url_key\n  }\n}"): (typeof documents)["query GetQuickAccessButton {\n  quickAccesses {\n    id\n    name\n    icon\n    icon_color\n    url_key\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetQuickAccesses {\n  quickAccesses {\n    id\n    index\n    name\n    icon\n    icon_color\n    url_key\n    created_at\n    updated_at\n  }\n}"): (typeof documents)["query GetQuickAccesses {\n  quickAccesses {\n    id\n    index\n    name\n    icon\n    icon_color\n    url_key\n    created_at\n    updated_at\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
