...
export function InventoryTable() {
  ...
  return (
    <Table variant="inventory">
      <TableHeader>
        <TableHead className="w-[25%] px-2 text-left">Product Name</TableHead>
        <TableHead className="w-[10%] px-2 text-left">Qty</TableHead>
        <TableHead className="w-[5%] px-2 text-left">Unit</TableHead>
        <TableHead className="w-[20%] px-2 text-left">Category</TableHead>
        <TableHead className="w-[15%] px-2 text-left">Expiry date</TableHead>
        <TableHead className="w-[15%] px-2 text-left">Status</TableHead>
        <TableHead className="w-auto text-center text-foreground h-10 align-middle font-medium whitespace-nowrap">
          Actions
        </TableHead>
      </TableHeader>
